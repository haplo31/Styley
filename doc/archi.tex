...
\tikzstyle{vertex}=[shape=rectangle, rounded corners,
  ...
  \node[vertex] (requestCreation) at (-8,-7) {requestCreation};
 ...
 \draw[->,>=latex] (exploreCreations) -- (exploreArtists);
  ...
  \draw[->,>=latex] (homeCustomer) -- (exploreCreations);
	...
	\node[vertex] (requestAddPerson) at (-12,-8) {requestAddPerson};
	\node[vertex] (requestDrawing) at (-12,-9) {requestDrawing};
	\node[vertex] (requestRemovePerson) at (-12,-10) {requestRemovePerson};
	\node[vertex] (requestRemoveObject) at (-12,-11) {requestRemoveObject};
	\node[vertex] (requestImprove) at (-12,-12) {requestImprove};
	\node[vertex] (requestIncrustation) at (-12,-13) {requestIncrustation};
	\node[vertex] (requestCustom) at (-12,-14) {requestCustom};

	


 \draw[->,>=latex] (requestCreation) to[bend left]  (requestAddPerson);
 \draw[->,>=latex] (requestCreation)  to[bend left]  (requestDrawing);
 \draw[->,>=latex] (requestCreation)  to[bend left]  (requestRemovePerson);
 \draw[->,>=latex] (requestCreation)  to[bend left]  (requestRemoveObject);
\draw[->,>=latex] (requestCreation)  to[bend left]  (requestImprove);
\draw[->,>=latex] (requestCreation)  to[bend left]  (requestIncrustation);
\draw[->,>=latex] (requestCreation)  to[bend left]  (requestCustom);
...
\draw[very thick] (-14,-3) -- (-10,-3) -- (-10,-15.5) -- (-14,-15.5) -- (-14,-3);
\node (DOC_explore) at (-12,-15) {components};
